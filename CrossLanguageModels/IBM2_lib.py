...
ibm2 = ibm2.IBMModel2(bitext, 100)

#print(type(ibm2.translation_table))

#for f in words_fr:
#	print(f, " ", "-", " ", max(ibm2.translation_table[f].items(), key=operator.itemgetter(1))[0])

final_dict = {}
for f in words_fr:
	final_dict[f] = max(ibm2.translation_table[f].items(), key=operator.itemgetter(1))[0]
